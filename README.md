...
- **2 大 Tab**：🏦 场外基金 / 📈 场内 ETF
- **场外 4 分组**（Chips 筛选）：标普500 / 纳指100 / 美股主动（精选 19 只白名单）/ 全球其他 QDII
- **场内 ETF 3 分组**（Chips 筛选）：标普500 / 纳指100 / 全球·其他 ETF
...
│       ├── global_other.json     # 🏦 场外 · 全球/其他 QDII（21 系列）
...
**Q: 数据不是今天的？**
A: QDII 净值 T+1~T+2 披露，今天看到的通常是前一交易日的净值。Actions 22:30 那轮覆盖绝大多数。
